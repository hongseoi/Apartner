...
<tr>
  ...
  <td><? echo $area1[0] ?> <a class="btn_popup" href="javascript:void(0);" onclick="window.open('monthgraph.php?'+wantcode, '_blank','top=140, left=300, width=500, height=400, menubar=no, toolbar=no, location=no, directories=no, status=no,  scrollbars=no, copyhistory=no, resizable=no');">예측가격 보러가기</a></td>
</tr>
<tr>
  <th scope="row">18.2~25.7평(60~85㎡) 이하</th>
  <td><?php echo $area2[0] ?><a class="btn_popup" href="javascript:void(0);" onclick="window.open('monthgraph.php?'+wantcode, '_blank','top=140, left=300, width=500, height=400, menubar=no, toolbar=no, location=no, directories=no, status=no,  scrollbars=no, copyhistory=no, resizable=no');">예측가격 보러가기</a></td>
</tr>
<tr>
